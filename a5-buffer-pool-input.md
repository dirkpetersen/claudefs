Create a new Rust file at /home/cfs/claudefs/crates/claudefs-fuse/src/buffer_pool.rs.

The file implements a reusable buffer pool for FUSE I/O to avoid repeated allocations.
...
impl Default for BufferPoolConfig {
    fn default() -> Self {
        Self { max_4k: 256, max_64k: 64, max_1m: 16 }
    }
}
...
impl BufferPoolStats {
    pub fn hit_rate(&self) -> f64 {
        ...
        if total == 0 { 0.0 } else { self.reuse_count as f64 / total as f64 }
    }
}
...
impl BufferPool {
    ...
    pub fn acquire(&mut self, size: BufferSize) -> Buffer {
        ...
        if let Some(buf) = pool.pop() {
            ...
            let id = self.next_id;
            self.next_id += 1;
            debug!("buffer_pool: allocated new buffer id={} size={:?}", id, size);
            Buffer {
    ...
    pub fn stats(&self) -> &BufferPoolStats { &self.stats }
...
mod tests {
    ...
    fn test_max_pool_limit_drops_excess() {
        let mut pool = BufferPool::new(BufferPoolConfig { max_4k: 2, max_64k: 64, max_1m: 16 });
...
Please write exactly this content to /home/cfs/claudefs/crates/claudefs-fuse/src/buffer_pool.rs
