...
[0m[0m[0m→ [0mRead crates/claudefs-fuse/src/crash_recovery.rs
I'll delegate this Rust documentation task to OpenCode.
[0m
...
Rules:
- Add `//!` module-level doc at the top of the file describing what this module does (crash recovery for FUSE filesystem)
...
```
EOF[93m[1m! [0mpermission requested: external_directory (/tmp/*); auto-rejecting
[0m✗ [0mbash failed
